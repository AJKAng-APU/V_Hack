...
// Navigation Button with enhanced hover and active states
const NavButton = ({ icon, label, active, onClick, colors }) => {
  ...
  return (
    ...
    >
      <div className={`w-12 h-12 rounded-full flex items-center justify-center transition-all duration-500 ${active ? 'shadow-md' : ''}`} 
        style={{ 
          background: active 
      ...
      <span className="text-xs mt-1 transition-all duration-300" style={{ 
        color: active ? colors.primary : colors.textSecondary,
